...
async function initial() {
    ...
    let chabot_icon_integration = () => {
        ...
        t.innerHTML = `<div style='position: fixed;bottom: 10px;right: 10px;z-index:9999;background:rgb(11 162 246);border-radius: 50%; padding: 13px;'>
                        <i id='close-chatbot-iocn' class='fas fa-comment' style='font-size:26px;color: white;'>Open</i>
                        <i id='open-chatbot-iocn' class=\"fas fa-times aaaqqq\" style='font-size:26px;color: white;padding: 0px 4px !important;display:none;'>Close</i>  
                         </div>`,
